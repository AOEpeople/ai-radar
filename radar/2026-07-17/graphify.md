...
- Not classic Graph-RAG: codebase-centric, deterministic (AST instead of LLM extraction), no embeddings, packaged as an assistant skill rather than a retrieval pipeline. 
- Young and 0.x (YC S26, rapid growth); verify the benefit over native agent search on your own large codebases. 
