...
Note the division of labor: [Gitleaks](/data-features/gitleaks/) covers secrets/credentials in code - PII in prompts, documents and logs needs the patterns above. (The gitleaks links in our previous entry pointed to a wrong path.)
